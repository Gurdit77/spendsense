...
const IncomeCard = ({ uqId, value}) => {
  ...
  return (
    <>
      ...
      <NavButton link={`/all-income/${uqId}`} type="nav">
        ...
        {noteDescription && (<Text className="block mb-2 border-t border-gray-600 pt-2 mt-2 text-sm  transition duration-300 text-gray-900 dark:text-gray-400">{noteDescription}</Text>)}
